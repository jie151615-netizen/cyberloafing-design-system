...
(function () {
  ...
  const STRINGS = {
    zh: {
      levelName: "卷纸狂人",
      levelNameEn: "Toilet Paper Runner",
  ...
  const TITLES = {
    low: {
      zh: "手抖新人 · 只敢轻轻扯",
      en: "Rookie Tearer — barely dares to tug",
      it: "Novellino Timido — tira appena appena"
    },
    mid: {
      zh: "洗手间哲学家",
      en: "Restroom Philosopher",
      it: "Filosofo del Bagno"
    },
    high: {
      zh: "带薪拉屎宗师",
      en: "Paid-Break Grandmaster",
      it: "Gran Maestro della Pausa Pagata"
    }
  };
  ...
  function PaperRoll({
    ...
    const stripPath = `M${stripX},${stripTop} L${stripX + stripW},${stripTop} L${stripX + stripW},${tornY - 9} ` + `L${stripX + 100},${tornY} L${stripX + 80},${tornY - 9} L${stripX + 60},${tornY} ` + `L${stripX + 40},${tornY - 9} L${stripX + 20},${tornY} L${stripX},${tornY - 9} Z`;
    return /*#__PURE__*/React.createElement("svg", {
      ...
      d: stripPath,
      fill: danger ? "var(--coral-wash)" : "var(--mint-wash)",
      stroke: danger ? "var(--red)" : "var(--ink)",
      strokeWidth: "2.5",
  ...
  function GameCore({
    ...
    useEffect(() => {
      onScoreChange && onScoreChange(banked + pending);
    }, [banked, pending]);
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "hud-value"
    }, Math.round(total).toLocaleString(lang === "zh" ? "zh-CN" : lang === "it" ? "it-IT" : "en-US")), /*#__PURE__*/React.createElement("div", {
      className: "hud-sub" + (pending > 0 ? " at-risk" : "")
    }, pending > 0 ? `${t.pointsAtRisk} +${Math.round(pending)}` : t.pointsBanked)), /*#__PURE__*/React.createElement("div", {
      className: "hud-block"
    }, /*#__PURE__*/React.createElement("div", {
      className: "hud-label"
    }, t.speedLabel), /*#__PURE__*/React.createElement("div", {
      className: "speed-bar"
    }, /*#__PURE__*/React.createElement("div", {
      ...
      className: "hud-sub" + (danger ? " danger-tag" : "")
    }, danger ? t.speedDanger : t.speedSafe))), /*#__PURE__*/React.createElement("div", {
      ...
      role: "button",
      tabIndex: 0,
      "aria-label": t.idleHint
    }, /*#__PURE__*/React.createElement(PaperRoll, {
    ...
    }, t.tearBonus)), !started && /*#__PURE__*/React.createElement("div", {
      className: "idle-hint"
    ...
    }, t.warningTitle), /*#__PURE__*/React.createElement("div", {
      className: "warning-body"
    }, t.warningBody), /*#__PURE__*/React.createElement("div", {
      ...
      disabled: !warning,
      onClick: () => {
        if (warning) resolveWarning(true);
      }
    }, t.flushButton), !warning && /*#__PURE__*/React.createElement("div", {
      className: "flush-hint"
    }, t.flushIdleHint)), /*#__PURE__*/React.createElement("p", {
